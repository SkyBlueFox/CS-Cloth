    ...
    >
        ...
        <nav class="mt-5 px-2 space-y-1">
            ...
            @if(Auth::user()->role == \App\Models\User::ROLE_SUPERADMIN)
                <a href="{{ route('superadmin.create-admin') }}" class="flex items-center px-4 py-2 mt-1 text-blue-100 hover:bg-blue-700 rounded transition duration-200">
                    <svg class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    Manage Admins
                </a>
                <a href="{{ route('superadmin.create-user') }}" class="flex items-center px-4 py-2 mt-1 text-blue-100 hover:bg-blue-700 rounded transition duration-200">
                    <svg class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    Manage Users
            ...
            @if(Auth::user()->role == \App\Models\User::ROLE_ADMIN)
                ...
                <a href="{{ route('admin.items.index')  }}" class="flex items-center px-4 py-2 mt-1 text-blue-100 hover:bg-blue-700 rounded transition duration-200">
                    <svg class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="{{ route('admin.questions.index') }}" class="flex items-center px-4 py-2 mt-1 text-blue-100 hover:bg-blue-700 rounded transition duration-200">
                    <svg class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    Pending Questions
            ...
            @if(Auth::user()->role == \App\Models\User::ROLE_USER)
                ...
                <a href="{{ route('questions.index') }}" class="flex items-center px-4 py-2 mt-1 text-blue-100 hover:bg-blue-700 rounded transition duration-200">
                    <svg class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    My Questions
