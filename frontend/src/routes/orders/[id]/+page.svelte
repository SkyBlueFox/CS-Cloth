        ...
        <div class="space-y-8">
            <section class="panel bg-slate-50/50">
                <header class="mb-10 border-b border-slate-200 pb-6">
                    ...
                    <h3 class="mt-2 text-2xl font-black text-slate-900 uppercase tracking-tight">Timeline</h3>
                </header>
                <div class="space-y-8 relative">
                    ...
                    {#each timelineEvents as event (event.key)}
                        <div class="relative pl-10">
                            ...
                            <p class="mt-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest">{formatDate(event.timestamp)}</p>
                        </div>
                    {/each}
                </div>
            </section>
            ...
            <section class="panel">
                <header class="mb-6">
                    ...
                    <h3 class="mt-2 text-xl font-black text-slate-900 uppercase tracking-tight">Delivery Info</h3>
                </header>
                <div class="rounded-2xl bg-slate-50 p-6 ring-1 ring-slate-100 space-y-4">
                    <p class="text-sm font-bold leading-relaxed text-slate-800 italic font-serif">
